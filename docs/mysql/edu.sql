...
CREATE TABLE `defense_voice`  (
                                  ...
                                  `create_by` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
                                  `update_by` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `system_config`  (
                                  ...
                                  `update_by` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
                                  PRIMARY KEY (`id`) USING BTREE
